...
extension AppLogQueryWhereSort on QueryBuilder<AppLog, AppLog, QWhere> {
  ...
  QueryBuilder<AppLog, AppLog, QAfterWhere> anyCreatedAt() {
    return QueryBuilder.apply(this, (query) {
...
extension AppLogQueryWhere on QueryBuilder<AppLog, AppLog, QWhereClause> {
  ...
  QueryBuilder<AppLog, AppLog, QAfterWhereClause> createdAtEqualTo(
      DateTime createdAt) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<AppLog, AppLog, QAfterWhereClause> createdAtNotEqualTo(
      DateTime createdAt) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
  ...
  QueryBuilder<AppLog, AppLog, QAfterWhereClause> createdAtGreaterThan(
    DateTime createdAt, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<AppLog, AppLog, QAfterWhereClause> createdAtLessThan(
    DateTime createdAt, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<AppLog, AppLog, QAfterWhereClause> createdAtBetween(
...
extension AppLogQueryFilter on QueryBuilder<AppLog, AppLog, QFilterCondition> {
  QueryBuilder<AppLog, AppLog, QAfterFilterCondition> createdAtEqualTo(
      DateTime value) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<AppLog, AppLog, QAfterFilterCondition> createdAtGreaterThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<AppLog, AppLog, QAfterFilterCondition> createdAtLessThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<AppLog, AppLog, QAfterFilterCondition> createdAtBetween(
    DateTime lower,
    DateTime upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<AppLog, AppLog, QAfterFilterCondition> sourceEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<AppLog, AppLog, QAfterFilterCondition> sourceGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<AppLog, AppLog, QAfterFilterCondition> sourceLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<AppLog, AppLog, QAfterFilterCondition> sourceBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<AppLog, AppLog, QAfterFilterCondition> sourceStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<AppLog, AppLog, QAfterFilterCondition> sourceEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<AppLog, AppLog, QAfterFilterCondition> sourceContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
  ...
  QueryBuilder<AppLog, AppLog, QAfterFilterCondition> sourceMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
  ...
  QueryBuilder<AppLog, AppLog, QAfterFilterCondition> sourceIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'source',
        value: '',
  ...
  QueryBuilder<AppLog, AppLog, QAfterFilterCondition> sourceIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'source',
        value: '',
...
extension AppLogQuerySortBy on QueryBuilder<AppLog, AppLog, QSortBy> {
  QueryBuilder<AppLog, AppLog, QAfterSortBy> sortByCreatedAt() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'createdAt', Sort.asc);
    });
  }

  QueryBuilder<AppLog, AppLog, QAfterSortBy> sortByCreatedAtDesc() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<AppLog, AppLog, QAfterSortBy> sortBySource() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'source', Sort.asc);
    });
  }

  QueryBuilder<AppLog, AppLog, QAfterSortBy> sortBySourceDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension AppLogQuerySortThenBy on QueryBuilder<AppLog, AppLog, QSortThenBy> {
  QueryBuilder<AppLog, AppLog, QAfterSortBy> thenByCreatedAt() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'createdAt', Sort.asc);
    });
  }

  QueryBuilder<AppLog, AppLog, QAfterSortBy> thenByCreatedAtDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'createdAt', Sort.desc);
    });
  }
  ...
  QueryBuilder<AppLog, AppLog, QAfterSortBy> thenBySource() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'source', Sort.asc);
    });
  }

  QueryBuilder<AppLog, AppLog, QAfterSortBy> thenBySourceDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'source', Sort.desc);
    });
  }
...
extension AppLogQueryWhereDistinct on QueryBuilder<AppLog, AppLog, QDistinct> {
  QueryBuilder<AppLog, AppLog, QDistinct> distinctByCreatedAt() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<AppLog, AppLog, QDistinct> distinctBySource(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension AppLogQueryProperty on QueryBuilder<AppLog, AppLog, QQueryProperty> {
  ...
  QueryBuilder<AppLog, DateTime, QQueryOperations> createdAtProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<AppLog, String, QQueryOperations> sourceProperty() {
    return QueryBuilder.apply(this, (query) {
