...
- Deep link теперь подхватывается через стартовый аргумент, native channel и pending-проверку Windows.
...
- Исправлен случай, когда браузер показывает "Открыть SiegeConnect", но после нажатия подписка не добавляется.
